            ...
            <div className="absolute right-0 top-[calc(100%+10px)] hidden w-[320px] cursor-default flex-col rounded-lg bg-white py-4 shadow-popup group-hover:flex">
               ...
               <div className="flex flex-col gap-2 p-4 pb-0">
                  <button
                     ...
                     className="w-full rounded-md bg-blue-500 px-4 py-2.5 text-sm text-white hover:bg-blue-600"
                  >
                     Checkout
                  </button>
                  <button
                     onClick={() => push('/cart')}
                     className="w-full rounded-md border-[1px] border-blue-500 px-4 py-2.5 text-sm text-blue-500 hover:bg-neutral-200 hover:bg-white"
                  >
                     View cart
                  </button>
               </div>
